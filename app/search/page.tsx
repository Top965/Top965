          ...
          <div className="card">
            ...
            {mode === 'signup' && <>
              ...
              <div className="field">
                ...
                <div className="username-wrapper">
                  ...
                  />
                  {usernameIcon && (
                    <span className="username-status" style={{ color: usernameColor }}>{usernameIcon}</span>
                  )}
                </div>
                {usernameMsg && (
                  <div className="username-hint" style={{ color: usernameColor }}>{usernameMsg}</div>
                )}
              </div>
              ...
              <button className="btn" onClick={handleStep1} disabled={loading || usernameStatus === 'checking' || usernameStatus === 'taken' || usernameStatus === 'invalid'}>
                Continue →
              </button>
            ...
            {mode === 'signup2' && <>
              ...
              <div className="privacy-notice">
                <span>🔒</span>
                <span>Your personal details are <strong>private</strong> and will never be shown to other users. Only your username appears publicly.</span>
              </div>
              ...
              <button className="btn" onClick={handleStep2} disabled={loading || !step2Complete}>
